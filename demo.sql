...
24006  300000003903584
     ...
     WHERE WorkOrderAnalyticsPEO.PLANNED_COMPLETION_DATE  BETWEEN  trunc(sysdate, 'mm')  AND   sysdate

with work_info_tab as (
...
SELECT  
          ...
          ,work_info_tab.OP_IN_PROCESS_QUANTITY 
          ,work_info_tab.OP_COMPLETED_QUANTITY 
          ,work_info_tab.WO_OPERATION_ID 
          ,work_info_tab.ORGANIZATION_ID 
          ,work_info_tab.WORK_ORDER_ID

FROM   work_info_tab  
WHERE work_info_tab.PLANNED_COMPLETION_DATE  BETWEEN  trunc(sysdate, 'mm')  AND   sysdate
